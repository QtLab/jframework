 ...
 */
class IJLogManager : public IJObject
{
public:
    enum LogType {
        LogConsole, LogFile
    ...
    // 获取对象标识
    virtual std::string objectIdentity() const { return IID_IJLogManager; }

    // 获取对象版本
    virtual unsigned int objectVersion() const { return VER_IJLogManager; }
