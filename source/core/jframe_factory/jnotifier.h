 ...
 */
class INotifier : public IJObject
{
public:
    virtual ~INotifier() {}

    // 获取对象标识
    virtual std::string objectIdentity() const { return IID_INotifier; }

    // 获取对象版本
    virtual unsigned int objectVersion() const { return VER_INotifier; }
