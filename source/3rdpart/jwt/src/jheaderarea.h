...
class JWT_EXPORT JSortFilterProxyModel : public QSortFilterProxyModel
{
    Q_OBJECT
public:
    explicit JSortFilterProxyModel(QObject *parent = 0);
    ~JSortFilterProxyModel();
...
public:
    ...
    JSortFilterProxyModel *filterModel();
    void setFilterProxyModel(JSortFilterProxyModel *model);
