    ...
    QMenu(parent)
{
    ...
    if (f & Qt::WindowMaximizeButtonHint) {
        QAction *actionRestore = new QAction(QIcon(":/jwt/image/sysmenu/restore.png"),
                                             tr("&Restore"), this);
    ...
    if (f & Qt::WindowMinimizeButtonHint) {
        QAction *actionMinimize = new QAction(QIcon(":/jwt/image/sysmenu/min.png"),
                                              tr("&Minimize"), this);
    ...
    //
    if (f & Qt::WindowMaximizeButtonHint) {
        QAction *actionMaximize = new QAction(QIcon(":/jwt/image/sysmenu/max.png"),
                                              tr("M&aximize"), this);
    ...
    if (f & Qt::WindowCloseButtonHint) {
        QAction *actionClose = new QAction(QIcon(":/jwt/image/sysmenu/close.png"),
                                           tr("Cl&ose"), this);
...
JDialogPrivate::JDialogPrivate(QWidget *parent, Qt::WindowFlags f)
    ...
    , titleHeight(30)
    , skinName(":/jwt/image/skin/shadow.png"), defShadowMargins(8, 8, 8, 8)
    ...
    , clientColor("#DDE4EF")
{
    ...
    pixmapRestore.load(":/jwt/image/title_button/restore.png");
    pixmapMax.load(":/jwt/title_button/max.png");
    ...
    buttonWhatsThis->setPixmap(":/jwt/image/title_button/arrow.png");  // TODO
...
*/
    ...
    buttonMinimized->setPixmap(":/jwt/image/title_button/min2.png");
    if (!(f & Qt::WindowMinimizeButtonHint)) {
    ...
    if (!(f & (Qt::WindowMinimizeButtonHint | Qt::WindowContextHelpButtonHint))
        ...
        buttonClose->setPixmap(":/jwt/image/title_button/dlg_close.png");
    } else {
        buttonClose->setPixmap(":/jwt/image/title_button/close.png");
    }
