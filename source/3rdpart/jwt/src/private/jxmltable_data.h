...
class JWT_EXPORT JValueBase : public QObject
{
    Q_OBJECT
...
class JWT_EXPORT JItemValue : public JValueBase
{
    Q_OBJECT
...
class JWT_EXPORT JBoolValue : public JItemValue
{
    Q_OBJECT
...
class JWT_EXPORT JNumericRange : public QObject
{
    Q_OBJECT
...
class JWT_EXPORT JNumericValue : public JItemValue
{
    Q_OBJECT
...
class JWT_EXPORT JStringValue : public JItemValue
{
    Q_OBJECT
...
class JWT_EXPORT JEnumOption : public QObject
{
    Q_OBJECT
    Q_PROPERTY(QString text READ text WRITE setText NOTIFY textChanged)
...
class JWT_EXPORT JEnumValue : public JItemValue
{
    Q_OBJECT
...
class JWT_EXPORT JDateTimeRange : public QObject
{
    Q_OBJECT
...
class JWT_EXPORT JDateTimeValue : public JItemValue
{
    Q_OBJECT
...
class  JWT_EXPORT JIPv4Value : public JItemValue
{
    Q_OBJECT
public:
...
class JWT_EXPORT JDelegateValue : public JItemValue
{
    Q_OBJECT
...
class JWT_EXPORT JPictureDelegateValue : public JDelegateValue
{
    Q_OBJECT
public:
...
class JWT_EXPORT JProgressDelegateValue : public JDelegateValue
{
    Q_OBJECT
    Q_PROPERTY(qreal minimum READ minimum WRITE setMinimum NOTIFY minimumChanged)
    Q_PROPERTY(qreal maximum READ maximum WRITE setMaximum NOTIFY maximumChanged)
