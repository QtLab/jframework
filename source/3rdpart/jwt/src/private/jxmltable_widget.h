...
class JWT_EXPORT JCheckBoxItem : public QStandardItem
{
public:
...
class JWT_EXPORT JBoolBox : public QCheckBox
{
    Q_OBJECT
...
class JWT_EXPORT JNumericIBox : public JSpinBox
{
    Q_OBJECT
    Q_PROPERTY(QByteArray jdata READ jdata WRITE jsetData)
    Q_PROPERTY(QVariant jvalue READ jvalue WRITE jsetValue)
...
class JWT_EXPORT JNumericLBox : public JLargeSpinBox
{
    Q_OBJECT
    Q_PROPERTY(QByteArray jdata READ jdata WRITE jsetData)
    Q_PROPERTY(QVariant jvalue READ jvalue WRITE jsetValue)
...
class JWT_EXPORT JNumericDBox : public QDoubleSpinBox
{
    Q_OBJECT
    Q_PROPERTY(QByteArray jdata READ jdata WRITE jsetData)
    Q_PROPERTY(QVariant jvalue READ jvalue WRITE jsetValue)
...
class JWT_EXPORT JStringItem : public QStandardItem
{
public:
...
class JWT_EXPORT JStringTEdit : public QPlainTextEdit
{
    Q_OBJECT
    Q_PROPERTY(QByteArray jdata READ jdata WRITE jsetData)
    Q_PROPERTY(QVariant jvalue READ jvalue WRITE jsetValue)
...
class JWT_EXPORT JEnumBox : public QComboBox
{
    Q_OBJECT
    Q_PROPERTY(QByteArray jdata READ jdata WRITE jsetData)
    Q_PROPERTY(QVariant jvalue READ jvalue WRITE jsetValue)
...
class JWT_EXPORT JMultiEnumBox : public JCheckComboBox
{
    Q_OBJECT
    Q_PROPERTY(QByteArray jdata READ jdata WRITE jsetData)
    Q_PROPERTY(QVariant jvalue READ jvalue WRITE jsetValue)
...
class JWT_EXPORT JDateTimeEdit : public QDateTimeEdit
{
    Q_OBJECT
    Q_PROPERTY(QByteArray jdata READ jdata WRITE jsetData)
    Q_PROPERTY(QVariant jvalue READ jvalue WRITE jsetValue)
...
class JWT_EXPORT JIPv4Edit : public JIPAddressEdit
{
    Q_OBJECT
    Q_PROPERTY(QByteArray jdata READ jdata WRITE jsetData)
    Q_PROPERTY(QVariant jvalue READ jvalue WRITE jsetValue)
