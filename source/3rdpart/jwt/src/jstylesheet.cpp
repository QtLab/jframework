...
QString JStyleSheet::styleSheet(const QString &name)
{
    if (name == QLatin1String("default")) {
        QFile file(QLatin1String(":/jwt/qss/stylesheet_default.qss"));
        if (!file.open(QFile::ReadOnly)) {
            return QString::null;
        }
        return file.readAll();
    } else if (name == QLatin1String("default-normal")) {
        QFile file(QLatin1String(":/jwt/qss/stylesheet_default_normal.qss"));
        if (!file.open(QFile::ReadOnly)) {
            return QString::null;
        }
        return file.readAll();
    } else if (name == QLatin1String("mainwidget")) {
        QFile file(QLatin1String(":/jwt/qss/stylesheet_mainwidget.qss"));
        if (!file.open(QFile::ReadOnly)) {
            return QString::null;
        }
        return file.readAll();
    } else if (name == QLatin1String("mainwidget_normal")) {
        QFile file(QLatin1String(":/jwt/qss/stylesheet_mainwidget_normal.qss"));
        if (!file.open(QFile::ReadOnly)) {
            return QString::null;
        }
        return file.readAll();
    } else if (name == QLatin1String("startPage")) {
        QFile file(QLatin1String(":/jwt/qss/stylesheet_startpage.qss"));
        if (!file.open(QFile::ReadOnly)) {
            return QString::null;
        }
        return file.readAll();
    } else if (name == QLatin1String("login")) {
        QFile file(QLatin1String(":/jwt/qss/stylesheet_default-login.qss"));
        if (!file.open(QFile::ReadOnly)) {
            return QString::null;
        }
        return file.readAll();
