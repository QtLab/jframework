...
/*!
\property QtRibbon::RibbonBar::currentIndexPage
*/
/*!
\property QtRibbon::RibbonBar::minimized
*/
/*!
\property QtRibbon::RibbonBar::maximized
*/

/*!
\class QtRibbon::RibbonBarPrivate
\internal
*/
...
//      nLeft = m_rcQuickAccess.left() + (!m_quickAccessOnTop ? 2 : 0);
    ...
    m_ribbonBarVisible = p.isTitleBarVisible() ? m_rcHeader.width() > 3 : opt.rect.width() >= 250;
...
QAction* RibbonBarPrivate::createSystemButton(const QIcon& icon, const QString& text)
{
    ...
    {
        QIcon iconQtnLogo;
        QIcon qtitan(":/OfficeStyle/qtRibbon.png");
        iconQtnLogo.addPixmap(qtitan.pixmap(QSize(64,56), QIcon::Disabled));
        QIcon icon32(":/OfficeStyle/qtRibbonlogo32x32.png");
