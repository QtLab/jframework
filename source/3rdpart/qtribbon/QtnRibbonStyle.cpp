...
/*!
    \enum QtRibbon::RibbonStyle::QPixelMetric

    This enum describes the various available pixel metrics of QtRibbon RibbonStyle. A pixel
...
/*!
    \enum QtRibbon::RibbonStyle::QPrimitiveElement

    This enum describes the various primitive elements of QtRibbon RibbonStyle. A
...
/*!
    \enum QtRibbon::RibbonStyle::QContentsType
...
/*!
    \enum QtRibbon::RibbonStyle::QControlElement
...
/*!
    \enum QtRibbon::RibbonStyle::QStyleHint
...
{
    QString family = "";//QString::fromWCharArray(lf.lfFaceName);//TODO
    QFont qf(family);
...
void RibbonStylePrivate::refreshMetrics(QWidget* widget)
{
    ...
    QTabBar tab;
    tab.setFont(qobject_cast<QtRibbon::RibbonTabBar*>(widget) ? widget->parentWidget()->font() : m_fontRegular);
...
int RibbonStyle::pixelMetric(PixelMetric pm, const QStyleOption* option, const QWidget* widget) const
{
    ...
    switch(pm) 
    {
        ...
        case PM_ToolBarSeparatorExtent:
            if (widget && (widget->metaObject()->className() == QString("QtRibbon::RibbonStatusBar")))
...
{
    QString pathCached = ":/OfficeStyle/Office2007Blue/";
    if (isStyle2010())
        pathCached = ":/OfficeStyle/Office2010Blue/";
    else if (getTheme() == Windows7Scenic)
        pathCached = ":/OfficeStyle/Windows7Scenic/";
    return pathCached;
}
...
//                qobject_cast<QtRibbon::RibbonPage*>(watched) || 
//                qobject_cast<QtRibbon::RibbonGroup*>(watched) ||
//                qobject_cast<QtRibbon::RibbonTabBar*>(watched))
            {
...
/*!
    \class QtRibbon::RibbonStylePlugin
    \internal
*/
