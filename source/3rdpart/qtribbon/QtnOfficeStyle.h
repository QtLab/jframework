...
namespace QtRibbon
{
    ...
    /* OfficeStyle */
    class QTRIBBON_EXPORT OfficeStyle : public CommonStyle
    {
        Q_OBJECT
        Q_ENUMS(Theme)
    ...
    protected:
        ...
        virtual void drawSplitButtonPopup(QPainter* p, const QRect& rect, bool
			selected, bool enabled, bool popuped) const;
