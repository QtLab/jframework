...
TARGET = $$qtLibraryTarget(com_demo4)
...
win32|unix: {
    ...
    copyCommand += && @echo ---- console - com_demo4 ----

    ## copy files
    dstdir = $${jframe_root}/component/com_demo4
    win32:dstdir = $$replace(dstdir, /, \\)
    !exists("$$dstdir"):copyCommand += && $(MKDIR) "$$dstdir"
    srcfile = $$PWD/com_demo4.xml
